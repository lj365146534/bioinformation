...
=cut
	...
	system ("bowtie2 --very-sensitive-local -x /home/lei/Desktop/flu_toolkit/zhuwenfei/kl25ref.fa -1 $outdir/$basename/trim_1.fastq -2 $outdir/$basename/trim_2.fastq  --un-conc $outdir/$basename/second_map/unmap.fq -S $outdir/$basename/second_map/second.sam -p $threads");
	...
	#samtools mpileup 
	system ("samtools mpileup -Q 0 -f /home/lei/Desktop/flu_toolkit/zhuwenfei/liuweixin.fa $outdir/$basename/second_map/$basename._second_sort.bam > $outdir/$basename/second_map/ref_dep");
